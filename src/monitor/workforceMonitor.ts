...
const DEFAULT_CONFIG: LevelConfig = {
  level: 1,
  roles: [
    { type: 'harvester', body: [WORK, CARRY, MOVE], tags: ['harvest', 'transport', 'move'], minCapacities: { harvest: 1, carry: 50 }, target: 2 },
    { type: 'upgrader',  body: [WORK, CARRY, MOVE], tags: ['work', 'transport', 'move'],    minCapacities: { work: 1, carry: 50 },   target: 1 },
    { type: 'builder',   body: [WORK, CARRY, MOVE], tags: ['work', 'transport', 'move'],    minCapacities: { work: 1, carry: 50 },   target: 1 },
  ],
};
